...
export class Backend implements backendInterface {
    ...
    async authenticateWithAdminPasskey(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.authenticateWithAdminPasskey(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getPriceForDiameter(arg0: string): Promise<number | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getPriceForDiameter(arg0);
    ...
    async getSiteSettings(): Promise<SiteSettings> {
        if (this.processError) {
            try {
                ...
                return from_candid_SiteSettings_n27(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async submitEnquiry(arg0: Enquiry): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.submitEnquiry(await to_candid_Enquiry_n33(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_Enquiry_n14(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _Enquiry): Promise<Enquiry> {
...
function from_candid_OrderType_n16(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _OrderType): OrderType {
...
function from_candid_SiteSettings_n27(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _SiteSettings): SiteSettings {
...
function from_candid_WhatsAppConfig_n30(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _WhatsAppConfig): WhatsAppConfig {
...
function from_candid_opt_n29(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_WhatsAppConfig]): WhatsAppConfig | null {
    return value.length === 0 ? null : from_candid_WhatsAppConfig_n30(_uploadFile, _downloadFile, value[0]);
}
...
async function from_candid_record_n15(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    email: string;
    requirementsFile: [] | [_ExternalBlob];
    timestamp: bigint;
    quantity: bigint;
    phoneNumber: string;
}): Promise<{
    ...
    return {
        ...
        pipeDiameter: value.pipeDiameter,
        orderType: from_candid_OrderType_n16(_uploadFile, _downloadFile, value.orderType),
        email: value.email,
        requirementsFile: record_opt_to_undefined(await from_candid_opt_n18(_uploadFile, _downloadFile, value.requirementsFile)),
...
async function from_candid_record_n22(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        diameterRange: value.diameterRange,
...
function from_candid_record_n31(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        prefilledMessage: record_opt_to_undefined(from_candid_opt_n32(_uploadFile, _downloadFile, value.prefilledMessage)),
        phoneNumber: value.phoneNumber
    };
}
...
function from_candid_variant_n17(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "placeOrder" in value ? OrderType.placeOrder : "requestQuote" in value ? OrderType.requestQuote : value;
}
...
async function from_candid_vec_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_Enquiry>): Promise<Array<Enquiry>> {
    return await Promise.all(value.map(async (x)=>await from_candid_Enquiry_n14(_uploadFile, _downloadFile, x)));
}
...
async function to_candid_Enquiry_n33(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Enquiry): Promise<_Enquiry> {
...
function to_candid_OrderType_n35(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: OrderType): _OrderType {
...
function to_candid_SiteSettings_n37(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: SiteSettings): _SiteSettings {
...
function to_candid_WhatsAppConfig_n39(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: WhatsAppConfig): _WhatsAppConfig {
...
async function to_candid_record_n34(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        customerName: value.customerName,
        pipeDiameter: value.pipeDiameter,
        orderType: to_candid_OrderType_n35(_uploadFile, _downloadFile, value.orderType),
        email: value.email,
        requirementsFile: value.requirementsFile ? candid_some(await to_candid_ExternalBlob_n10(_uploadFile, _downloadFile, value.requirementsFile)) : candid_none(),
        timestamp: value.timestamp,
        quantity: value.quantity,
        phoneNumber: value.phoneNumber
    };
...
function to_candid_record_n40(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        prefilledMessage: value.prefilledMessage ? candid_some(value.prefilledMessage) : candid_none(),
        phoneNumber: value.phoneNumber
    };
}
...
function to_candid_variant_n36(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: OrderType): {
    placeOrder: null;
} | {
    requestQuote: null;
} {
    return value == OrderType.placeOrder ? {
        placeOrder: null
    } : value == OrderType.requestQuote ? {
        requestQuote: null
    } : value;
}
